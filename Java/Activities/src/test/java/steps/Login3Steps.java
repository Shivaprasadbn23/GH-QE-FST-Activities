...
public class Login3Steps extends BaseClass {
    ...
    @When("the user enters username and password for activity5")
    ...
    @Then("get the confirmation message and verify it for activity5")
