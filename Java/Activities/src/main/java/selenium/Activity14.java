...
public class Activity14 {
    public static void main(String[] args) {
        ...
        WebElement cellValue = driver.findElement(By.xpath("//html/body/div/main/div/div/div/div/div[2]/table/tbody/tr[5]/td[2]"));
        ...
        cellValue = driver.findElement(By.xpath("//html/body/div/main/div/div/div/div/div[2]/table/tbody/tr[5]/td[2]"));
